...
print(human_readable_names)
print(original_names)
for index, column in enumerate(df.columns):
        df = df.withColumnRenamed(df.columns[index], human_readable_names[original_names[index]])
        # df.rename(columns={df.columns[index]: human_readable_names[original_names[index].upper()]}, inplace=True)
